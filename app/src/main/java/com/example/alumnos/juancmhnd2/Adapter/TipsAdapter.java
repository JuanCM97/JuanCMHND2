package com.example.alumnos.juancmhnd2.Adapter;
...
import java.util.List;
    ...
    public class TipsAdapter extends ArrayAdapter<TipsBean> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            com.example.alumnos.juancmhnd2.Adapter.TipsAdapter.ViewHolder viewHolder;
            ...
            if (view == null) {
                ...
                viewHolder = (com.example.alumnos.juancmhnd2.Adapter.TipsAdapter.ViewHolder) view.getTag();
            }
